...
forest.raster.cropped[[i]]$patches.immigration<-data.frame(patches.immigration=unique(forest.raster.cropped[[i]]$forest.raster.cropped.labeled[])) %>% 
  filter(patches.immigration>0 & patches.immigration!=forest.raster.cropped[[i]]$focal.patch.label.cropped) %>% 
  .$patches.immigration
}
