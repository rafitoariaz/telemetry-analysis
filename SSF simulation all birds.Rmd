...
for (i in 1:length(forest.raster.cropped)){
  ...
  map.only.focal.patch<-buffer(map.only.focal.patch,width=1695.15/2)
...
#for (i in 1:nrow(parameters.simulations)){
  ...
  results.simulations.list <- foreach (i= c(1:6,8,9,11:20,22:23), #c(1:6,8,9,11:20,22:23), #11 #1:nrow(parameters.simulations),
...
for (i in c(10)){ #not included: 4,9,11,13
start <- Sys.time()
