...
#I DO NOT SEE ANY DRASTIC CHANGES, SO i COUL USE THE MEDIAN OF THE SCALE PARAMETER
...
#save.image("simulation_modelling_workspace.RData")
...
```{r}
borrar <- dget("results.simulations.list")
```
