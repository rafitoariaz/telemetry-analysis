...
#PENDING ACTIVITIES
  ...
  #I need to register how many times the code is doing a simulation when it lands outside the raster map. However, it is working when I run the code individually but it is not working when I run the code in parallel. The data frame it is called test.new.coords
...
#for (i in 1:nrow(parameters.simulations)){
  ...
  results.simulations.list <- foreach (i= c(1),#1:6,8,9,11:20,22:23), #c(1:6,8,9,11:20,22:23), #11 #1:nrow(parameters.simulations),
